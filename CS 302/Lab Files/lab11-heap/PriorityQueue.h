...
class PriorityQueue : public Heap<DataType>
{
  public:
    ...
    // Constructor
    PriorityQueue ( int maxNumber = defMaxQueueSize ) : Heap<DataType, KeyType, Comparator>(maxNumber) {}
	PriorityQueue ( const Heap<DataType, KeyType, Comparator>& other) : Heap<DataType>(other) {}
